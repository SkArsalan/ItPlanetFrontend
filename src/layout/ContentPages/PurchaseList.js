    ...
    <div className=" container mt-5 page-wrapper">
      <div className="content">
        ...
        <div className="page-header">
          ...
          <div className="d-flex justify-content-between mb-2"> <h4 className="fw-bold text-secondary">PURCHASE LIST</h4>
              ...
              <table className="table table-hover">
                <thead className="table-light">
                  <tr>
                    ...
                    {["Supplier Name", "Reference", "Date", "Status", "Grand Total", "Paid", "Due", "Payment Status", "Action"].map(
                      (heading, index) => (
